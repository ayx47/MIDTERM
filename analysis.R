...
output <- function(x) {
    ...
    ASIANT <- unite(code1111[155:165], "ASIANT", c(ASIANF10, ASIANF1, ASIANF1_2, ASIANF2, ASIANF3, ASIANF4, ASIANF5, ASIANF6, ASIANF7, ASIANF8, ASIANF9),sep = ",")
    ...
    AIANT <- unite(code1111[188:198], "AIANT", c(AIANF10, AIANF1, AIANF1_2, AIANF2, AIANF3, AIANF4, AIANF5, AIANF6, AIANF7, AIANF8, AIANF9),sep = ",")
    
    agrt <- cbind(Total, MT, FT, WHT, WHM, WHF, BLKT, BLKM, BLKF, HISPT, HISPM)
